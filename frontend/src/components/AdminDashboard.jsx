    ...
    const createTestCourseAndAssignUsers = async () => {
        ...
        try {
            ...
            const courseResponse = await apiClient.post('/courses/', {
                titulo: "Curso de Prueba - Asignación Automática",
                descripcion: "Curso creado automáticamente para asignar usuarios sin cursos"
            });
            ...
            const students = allUsers.filter(u => {
                ...
                return userRole === 'estudiante' || userRole === 'ESTUDIANTE';
            });
                    ...
                    <div className="flex justify-between items-start mb-4">
                        <div>
                            ...
                            <p className="text-sm text-gray-600">
                                Curso: {courses.find(c => c.id === selectedCourse)?.titulo || courses.find(c => c.id === selectedCourse)?.title}
                            </p>
                        </div>
                        <button
                            onClick={() => {
